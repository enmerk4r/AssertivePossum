...
public class ReportToMarkdownComponent : GH_Component
{
    public ReportToMarkdownComponent()
        : base("Report to Markdown", "MD",
            "Serializes test reports to Markdown format.",
            "Assertive Possum", "3. Reporting")
    {
    }

    public override Guid ComponentGuid => new("E5F6A7B8-C9D0-4E12-3F4A-5B6C7D8E9F0A");

    protected override Bitmap? Icon =>
        new Bitmap(GetType().Assembly.GetManifestResourceStream("Icons.report-to-markdown.png")!);
    ...
    {
        pManager.AddTextParameter("Markdown", "M", "The Markdown output string.", GH_ParamAccess.item);
    }
    ...
    protected override void SolveInstance(IGH_DataAccess DA)
    {
        ...
        string markdown = MarkdownSerializer.Serialize(reports);
        DA.SetData(0, markdown);
